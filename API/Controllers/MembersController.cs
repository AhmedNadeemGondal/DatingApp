...
namespace API.Controllers
{
    ...
    IPhotoService photoService) : BaseApiController
    {
        ...
        {
            var member = await uow.MemberRepository.GetMemeberByIdAsync(id);
        ...
        public async Task<ActionResult> UpdateMember(MemberUpdateDto memberUpdateDto)
        {
            ...
            var member = await uow.MemberRepository.GetMemeberForUpdate(memberId);
        ...
        {
            var member = await uow.MemberRepository.GetMemeberForUpdate(User.GetMemberId());
